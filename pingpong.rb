...
bot.message(start_with:"$Mset") do |event|
    ...
    if (pIndex != nil) && (weaponInt != false) && (weaponInt < 6) then; 
           ...
           say = @player[pIndex][0].to_s + " MELEE weapon damage has been set to " + @weapon[(@player[pIndex][1])].to_s;
    else
...
bot.message(start_with:"$Rset") do |event|
    ...
    if (pIndex != nil) && (weaponInt != false) && (weaponInt < 6) then; 
           ...
           say = @player[pIndex][0].to_s + " RANGED weapon damage has been set to " + @weapon[(@player[pIndex][12])].to_s;
    else
       say = "Please try: $Mset?  where ? is a single number ( 0 to 5 )"; 
    end;
    event.respond say;
